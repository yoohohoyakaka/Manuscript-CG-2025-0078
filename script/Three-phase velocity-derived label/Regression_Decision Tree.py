...
print("==========🚩 Biot-Based Hydrate Regression (Decision Tree) ==========")
...
# Step 4: Define the Decision Tree Regressor with specified hyperparameters
...
cv_scores = cross_val_score(dt_regressor, X_scaled, y, cv=cv, scoring='r2')
