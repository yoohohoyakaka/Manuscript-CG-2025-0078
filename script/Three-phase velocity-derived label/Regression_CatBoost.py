...
print("==========🚩 Biot-Based Hydrate Regression (CatBoost) ==========")
...
# Step 4: Define CatBoost Regressor with specified hyperparameters
...
cv_scores = cross_val_score(cat_regressor, X_scaled, y, cv=cv, scoring='r2')
