...
print("==========🚩 Biot-Based Hydrate Regression (GPR) ==========")
...
# Step 4: Define Gaussian Process Regressor with specified kernel
...
cv_scores = cross_val_score(gpr_regressor, X_scaled, y, cv=cv, scoring='r2')
