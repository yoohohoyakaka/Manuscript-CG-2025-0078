...
print("==========🚩 Biot-Based Hydrate Regression (Bagging) ==========")
...
# Step 4: Define the Bagging Regressor with specified base estimator and parameters
...
cv_scores = cross_val_score(bagging_regressor, X_scaled, y, cv=cv, scoring='r2')
