...
print("==========🚩 Biot-Based Hydrate Classification using CatBoost ==========")
...
# 4. Initialize CatBoost classifier with specified hyperparameters
...
cv_scores = cross_val_score(cat_classifier, X, y, cv=skf, scoring="accuracy")
